...
Latest parity audit follow-up (against `~/dev/bitcoin/bitcoin`, February 14, 2026) closed the previously identified consensus-critical deltas listed below. The phase remains in progress for continued differential hardening and maintenance, not because of known open Taproot consensus mismatches from that audit set.
